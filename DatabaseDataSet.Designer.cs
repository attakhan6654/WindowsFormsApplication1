...
namespace WindowsFormsApplication1 {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class PicturesDataTable : global::System.Data.TypedTableBase<PicturesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PicturesRow AddPicturesRow(string FileName, byte[] Image) {
...
namespace WindowsFormsApplication1.DatabaseDataSetTableAdapters {
    ...
    public partial class PicturesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Pictures] ([FileName], [Image]) VALUES (@FileName, @Image);\r\nS" +
                "ELECT Id, FileName, Image FROM Pictures WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Pictures] SET [FileName] = @FileName, [Image] = @Image WHERE (([Id]" +
                " = @Original_Id) AND ((@IsNull_FileName = 1 AND [FileName] IS NULL) OR ([FileNam" +
                "e] = @Original_FileName)));\r\nSELECT Id, FileName, Image FROM Pictures WHERE (Id " +
                "= @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FileName, Image FROM dbo.Pictures";
        ...
        public virtual int Fill(DatabaseDataSet.PicturesDataTable dataTable) {
        ...
        public virtual DatabaseDataSet.PicturesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DatabaseDataSet.PicturesDataTable dataTable = new DatabaseDataSet.PicturesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatabaseDataSet.PicturesDataTable dataTable) {
        ...
        public virtual int Insert(string FileName, byte[] Image) {
            if ((FileName == null)) {
        ...
        public virtual int Update(string FileName, byte[] Image, int Original_Id, string Original_FileName, int Id) {
            if ((FileName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FileName, byte[] Image, int Original_Id, string Original_FileName) {
            return this.Update(FileName, Image, Original_Id, Original_FileName, Original_Id);
        }
    }
